...
def node_bidirectional_thermal(state):
    ...
    payload = {"Pout": app.get("output_power_w_nom", 3600.0), "eff": overrides.get("eff", 0.95), "max_rise_c": thermal.get("max_temp_rise_c", 40.0), "max_enclosure_rth_c_per_w": thermal.get("max_enclosure_rth_c_per_w", 0.5), "fsw": overrides.get("fsw", 70000.0)}
