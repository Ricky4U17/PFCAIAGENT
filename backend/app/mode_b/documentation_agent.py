    ...
    def _assess_chapters(self, approved_design, step15_result, step16_params) -> list[ChapterStatus]:
        ...
        chapters.append(ChapterStatus(
            ...
            sections=["5.1 Capacitor sizing — hold-up and ripple requirements",
                      "5.2 Selected capacitor and configuration verification",
                      "5.3 ESR and I<sub>rms</sub> ratings check",
                      "5.4 Thermal analysis across 9 operating points"],
        ...
        chapters.append(ChapterStatus(
            ...
            sections=["6.1 Control architecture overview",
                      "6.2 Plant model — G<sub>id</sub>(s) and G<sub>vp</sub>(s) derivations",
                      "6.3 Current loop compensator design",
                      "6.4 Voltage loop compensator design",
                      "6.5 Stability verification — Bode plots and margins"],
